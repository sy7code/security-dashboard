      ...
      try {
        ...
        if (err instanceof Error && err.message.includes('Network Error')) {
          const mockData: Vulnerability[] = [
            ...
            { id: 2, threatType: "XSS Vulnerability", severity: "HIGH", status: "PENDING", approvalStatus: "PENDING", createdAt: new Date(Date.now() - 86400000).toISOString() },
            { id: 3, threatType: "Insecure Direct Object Reference", severity: "MEDIUM", status: "OPEN", approvalStatus: "OPEN", createdAt: new Date(Date.now() - 86400000 * 2).toISOString() },
